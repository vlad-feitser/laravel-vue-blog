    ...
    <div id="wrapper">  
      ...
      <div class="sidebar" :class="{showOverlay:overlayVisibility}">
        ...
        <div class="side-links">
          <ul>
            <li><router-link class="slide-links" @click="HideOverlay" :to="{name: 'Home'}">Home</router-link></li>
        ...
        <footer class="sidebar-footer">
          ...
          <small>&copy; 2023 Vlad Feitser Blog</small>
        </footer>
      </div>
      <!-- Menu Button -->
      ...
      <main class="container">
        ...
        <router-view @update-sidebar="updateSidebar" @show-edit-success="showEditSuccess" :editSuccess="editSuccess" :key="$route.path"></router-view>
      </main>
